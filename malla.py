        ...
        for i in range(self.filas):
            for j in range(self.columnas):
                ...
                if (i == 0 or j == 0 or i == self.filas - 1 or 
                    ...
                    self.matrixJacobiana[ecuacion, idx-1] = (1/4) + vec_0[idx]
                    self.matrixJacobiana[ecuacion, idx+self.columnas-1] = (1/4) + v_ij
                    self.matrixJacobiana[ecuacion, idx-self.columnas-1] = (1/4) - v_ij
...
def main():
    ...
    for i in range(max_iterations):
        ...
        print("Es diagonalmente dominante:", es_diagonalmente_dominante(xinit.matrixJacobiana, strict=True))
